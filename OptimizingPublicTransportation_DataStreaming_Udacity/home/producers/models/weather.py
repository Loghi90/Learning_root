...
class Weather(Producer):
    ...
    def __init__(self, month):
        ...
        #
        super().__init__(
            f"CTA_project_1_weather_info_during_month_{month}", # TODO: Come up with a better topic name
    ...
    def run(self, month):
        ...
        AVRO_SCHEMA = json.dumps(Weather.value_schema)
        ...
        try:
            ...
            print(f"Failed to send data {json.dumps(resp.json(),indent =2)}")
